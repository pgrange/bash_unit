...
Be carefull however that your \_ps function is not exported to sub-processes. It means that, depending on how your code under test works, _ps may not be defined in the context where _ps_ will be called. For instance:
